...
def re_create_service(message: types.Message):
    text = "Неправильный формат данных. Удостоверьтесь, что отправленное сообщение соответсвует необходимому формату. Отправьте сообщение ещё раз."
...
def get_appointments(call: types.CallbackQuery):
    ...
    markup = appointments_markup(appointments=appointments)
